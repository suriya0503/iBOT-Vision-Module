...
while True:
    _,img = cap.read()
    #height ,width and layers of the image
...
#Model Input
    net.setInput(blob)
#finding the unconnected layers
    output_layers_names = net.getUnconnectedOutLayersNames()
#returns an array of output layers
...
#first 5 are the dimensions of box and if object is present or not 
            scores = detection[5:] 
...
#Drawing Rectangles
    for i in indexes.flatten():
        ...
        cv.putText(img,label+" " + confidence , (x , y+20) , font , 2 ,color,2)
